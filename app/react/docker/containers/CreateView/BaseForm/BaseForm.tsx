      ...
      <Widget.Body>
          ...
          >
            <div className="form-group">
              <div className="col-sm-12">
                <SwitchField
                  label="总是拉取镜像"
                  tooltip="启用后，Portainer 会在创建容器前自动尝试拉取指定镜像。"
              ...
              <div className="form-group">
                <div className="col-sm-12">
                  <SwitchField
                    ...
                    tooltip="创建一个 Webhook（或回调 URI）以自动重建此容器。向该回调 URI 发送 POST 请求（无需认证）后，会拉取关联镜像的最新版本并重新创建此容器。"
        ...
        <FormSection title="网络端口配置">
          <div className="form-group">
            <div className="col-sm-12">
              <SwitchField
                label="将所有暴露端口发布到随机主机端口"
                data-cy="publish-all-ports-switch"
                tooltip="启用后，Portainer 会让 Docker 自动将主机上的随机端口映射到镜像 Dockerfile 中定义的每个暴露端口。"
        ...
        <div className="form-group">
          <div className="col-sm-12">
            <SwitchField
              ...
              tooltip="启用后，Portainer 会在容器退出时自动将其删除。这适用于只需临时运行一次容器的场景。"
