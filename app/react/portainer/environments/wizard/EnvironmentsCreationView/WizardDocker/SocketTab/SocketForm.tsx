    ...
    <>
      ...
      {values.overridePath && (
        <FormControl
          ...
          tooltip="Docker Socket 的路径。请记得绑定挂载该 Socket，更多信息请参阅上方的重要提示。"
          errors={errors.socketPath}
        >
          <Field
            name="socketPath"
            as={Input}
            placeholder="例如：/var/run/docker.sock（Linux）或 //./pipe/docker_engine（Windows）"
          />
        </FormControl>
      )}
    </>
