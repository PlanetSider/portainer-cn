                  ...
                  {!isIngressClassOptionsLoading && (
                    <>
                      <Select
                        ...
                        noOptionsMessage={() => '没有可用 Ingress 类别'}
            ...
            <Card.Container key={host.Key} variant="filled" className="mb-5">
              <Card.Body>
                <div className="flex flex-col">
                      ...
                      <div className="form-group col-sm-6 col-lg-4 !pl-2 !pr-0">
                        <InputGroup size="small">
                          ...
                          <Select
                            ...
                            noOptionsMessage={() => '没有可用的 TLS Secret'}
                            size="sm"
                  ...
                  {host.NoHost && (
                    <TextTip color="blue">
                      回退规则未指定主机名。只有当传入请求的主机名与其他规则均不匹配时，才会应用此规则。
                    </TextTip>
                  )}
                  ...
                  {!host.Paths.length && (
                    <TextTip className="mt-2" color="blue">
                      你可以不设置路径直接保存 Ingress；保存后它会成为<b>默认 Ingress</b>，用户可以在创建或编辑应用时通过主机名下拉列表选择它。
                    </TextTip>
                  )}
                      ...
                      <div className="form-group col-sm-3 col-xl-2 !m-0 !pl-0">
                        <InputGroup size="small">
                          ...
                          <Select
                            ...
                            noOptionsMessage={() => '没有可用的 Service'}
                            size="sm"
