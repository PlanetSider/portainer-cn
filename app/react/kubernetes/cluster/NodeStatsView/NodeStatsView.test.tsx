...
describe('NodeStatsView', () => {
  it('renders the page header "节点统计信息"', () => {
    server.use(
    ...
    expect(screen.getByText('节点统计信息')).toBeInTheDocument();
  });

  it('shows "无法获取节点指标" panel when metrics fetch returns 500', async () => {
    server.use(
      http.get('/api/kubernetes/1/metrics/nodes/my-node', () =>
