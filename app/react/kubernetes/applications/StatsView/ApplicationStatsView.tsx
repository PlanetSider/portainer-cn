  ...
  return (
    <>
      ...
      {metricsState === 'unavailable' && (
        <InformationPanel title="无法获取容器指标">
          <span className="small text-warning">
            Portainer 无法获取与该容器关联的任何指标。请联系管理员，确认 Kubernetes 指标功能已正确配置。
          </span>
        </InformationPanel>
      )}
        ...
        <>
                  ...
                  <form className="form-horizontal">
                    <div className="form-group">
                      <div className="col-sm-12">
                        <span className="small text-warning">
                          此视图显示容器 <b>{containerName}</b> 的实时统计信息。
                        </span>
                      </div>
                    </div>
                    <div className="form-group">
          ...
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <Widget>
                <WidgetTitle icon="svg-memory" title="内存使用情况" />
                <WidgetBody>
                  <StatsLineChart
                    data={chartData}
                    series={[
            ...
            <div className="col-lg-6 col-md-12">
              <Widget>
                <WidgetTitle icon="cpu" title="CPU 使用情况" />
                <WidgetBody>
                  <StatsLineChart
                    data={chartData}
                    series={[
